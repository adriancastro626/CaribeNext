...
const HeaderMenuContent = ({ float = "" }) => {
  ...
  const pages = [
    ...
    { id: 11, name: "Corporate Profile", routerPath: "/corporate" },
    { id: 12, name: "Our Strategy", routerPath: "/strategy" },
    { id: 13, name: "Sustainability", routerPath: "/sustainability" },
    // Sustainability
  ];
    ...
    >
      ...
      <li className="last">
        <Link href="/properties">
          <a
            className={route.pathname === "/properties" ? "ui-active" : undefined}
          >
            Portfolio
          </a>
        </Link>
